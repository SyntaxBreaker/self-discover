  ...
  return (
    ...
    >
      <path
        fill="none"
        stroke="#FFFFFF"
        d="M2 5.5h11m-11 4h11m-6.5-8l-2 12m6-12l-2 12"
      ></path>
    </svg>
  );
}
...
function RiMentalHealthFill() {
  return (
    ...
    >
      <path
        fill="white"
        d="M11 2a8.002 8.002 0 0 1 7.934 6.965l2.25 3.539c.148.233.118.58-.225.728L19 14.07V17a2 2 0 0 1-2 2h-1.999L15 22H6v-3.694c0-1.18-.436-2.297-1.245-3.305A8 8 0 0 1 11 2Zm-.53 5.763a1.75 1.75 0 0 0-2.475 2.474L11 13.243l3.005-3.006a1.75 1.75 0 1 0-2.475-2.474l-.53.53l-.53-.53Z"
      ></path>
    </svg>
  );
}
...
function PhCurrencyDollarSimple() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="40px"
